/*******************************
 *
 * File: sd_dev_adafruit_MPL115A2_pressure.cpp
 *
...
/******************************
 *
 * Name:        sd_dev_adafruit_MPL115A2_pressure_open
 * Returns:     Nothing
 * Parameter:   Nothing
...
/******************************
 *
 * Name:        sd_dev_adafruit_MPL115A2_pressure_pa_read
...
/******************************
 *
 * Name:        sd_dev_adafruit_MPL115A2_pressure_pa_test
 * Returns:     Nothing
 * Parameter:   Nothing
...
void sd_dev_adafruit_MPL115A2_pressure_pa_test(void){
    ...
    uint32_t mpl115a2t1_pressure_pa_val = sd_dev_adafruit_MPL115A2_pressure_pa_read();

/*******************************
 *
 * File: sd_dev_apogee_SP212_irradiance.cpp
 *
...
/******************************
 *
 * Name:        sd_dev_apogee_SP215_irradiance_open
 * Returns:     Nothing
 * Parameter:   Nothing
...
void sd_dev_apogee_SP215_irradiance_open(void){
    pinMode(_PIN_SD_APOGEE_SP215_IRRADIANCE_, INPUT);
}

/******************************
 *
 * Name:        sd_dev_apogee_SP215_irradiance_read_raw
...
int sd_dev_apogee_SP215_irradiance_read_raw(void){
    int value = analogRead(_PIN_SD_APOGEE_SP215_IRRADIANCE_);
    return value;
}

/******************************
 *
 * Name:        sd_dev_apogee_sp215_read
 * Returns:     Solar irradiance value in millivolts (mV)
 * Parameter:   Nothing
...
int sd_dev_apogee_SP215_irradiance_read(void){
    int value = 555;
    #ifndef SEN_STUB
    value = (float)analogRead(_PIN_SD_APOGEE_SP215_IRRADIANCE_)*(2500.0/1023.0);
    #endif
    return value;
}
